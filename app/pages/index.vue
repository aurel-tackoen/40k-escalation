      ...
      <div class="container mx-auto px-4">
        ...
        <div class="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div class="bg-gray-800 border border-gray-700 rounded-lg p-6 hover:border-yellow-600 transition-colors">
            ...
            <p class="text-gray-400">
              Build armies with point validation, track painting progress, and manage escalation across phases.
            </p>
          </div>
        </div>
      </div>
            ...
            <div class="bg-gray-800/50 border border-gray-700 rounded-lg p-6 hover:border-yellow-600/50 transition-colors">
              <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                  ...
                  <p class="text-gray-400">
                    Master your army's core units before adding complexity. Each phase introduces new strategies and synergies
            ...
            <div class="bg-gray-800/50 border border-gray-700 rounded-lg p-6 hover:border-yellow-600/50 transition-colors">
              <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                  ...
                  <p class="text-gray-400">
                    Stay motivated with manageable painting goals each phase. Track your progress and compete on the painting leaderboard
            ...
            <div class="bg-gray-800/50 border border-gray-700 rounded-lg p-6 hover:border-yellow-600/50 transition-colors">
              <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                  ...
                  <p class="text-gray-400">
                    Spread your hobby purchases over time instead of buying everything at once. Each phase gives you weeks to acquire,
