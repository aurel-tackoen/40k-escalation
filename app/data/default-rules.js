...
### Point Limits
- Each phase has a specific point limit (see Phase Configuration)
- Armies **must not exceed** the current phase's point limit
- Under-strength armies are allowed but not recommended

### List Submission
- Army lists must be submitted **before each phase begins**
- Late submissions may result in match forfeits
- Lists can be modified between phases, but not during a phase
...
- Each player must complete **at least one match per phase**
...
### Scheduling
- Matches must be completed within the phase timeframe
...
### Championship
- Final standings at the end of all phases determine the league champion
